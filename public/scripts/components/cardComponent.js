 ...
 */
 ...
 createElement("div", { className: "primary-lang-text", parent: translationEl });

 createElement("button", {
 className: "fc-audio-button absolute bottom-4 left-1/2 transform -translate-x-1/2 p-2 rounded-full hover:bg-opacity-75 transition-all",
 html: `
 ...
 */
 ...
 className: "card bg-learning-app-design-3 shadow-card hover:shadow-card-hover transition-shadow duration-300 rounded-2xl group" 
 });
 
 const cardBody = createElement("div", { 
 className: "card-body p-2 flex flex-col justify-between", 
 parent: cardDiv 
 });
